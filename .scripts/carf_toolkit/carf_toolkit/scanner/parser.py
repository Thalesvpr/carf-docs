...
from ..models.file_item import LinkInfo
...
class FrontmatterParser:
    ...
    # Pattern to extract footer metadata (CARF format)
    ...
    def parse_content(
        ...
        result["last_updated"] = (
            ...
            footer_metadata.get("Ultima atualizacao")
        )
        result["description"] = (
            footer_metadata.get("Descricao") or
            footer_metadata.get("Descrição") or
            ""
        )
