"""Action bar with approve/reject/skip buttons."""
...
class ActionBar(QFrame):
    """Action bar with curation buttons and keyboard shortcuts."""
    ...
    def _setup_ui(self) -> None:
        ...
        self.edit_button.setToolTip("Edit review card (E)")
    ...
    def _setup_shortcuts(self) -> None:
        ...
        # These work when the main window has focus
        pass  # Shortcuts are set up in MainWindow for better control
