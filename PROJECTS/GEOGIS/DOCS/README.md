...
- **[ARCHITECTURE/](./ARCHITECTURE/README.md)** - Integração Keycloak OAuth2 desktop
- **[CONCEPTS/](./CONCEPTS/README.md)** - Autenticação armazenamento tokens
- **[FEATURES/](./FEATURES/README.md)** - Integração GIS importação shapefile
