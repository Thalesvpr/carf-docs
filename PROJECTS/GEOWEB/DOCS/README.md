...
Portal web React + Vite para gestão de processos de regularização fundiária urbana (REURB) permitindo técnicos municipais e gestores visualizarem mapas de comunidades, cadastrarem unidades habitacionais online, gerenciarem titulares, acompanharem processos de legitimação e exportarem relatórios para análise. Integração com backend realizada via [GEOAPI](../../GEOAPI/DOCS/ARCHITECTURE/01-overview.md) consumindo APIs REST documentadas em [CENTRAL/API](../../../CENTRAL/API/README.md) através de [@carf/geoapi-client](../../LIB/TS/GEOAPI-CLIENT/DOCS/README.md) HTTP client tipado garantindo type safety end-to-end.

Autenticação implementada via [Keycloak](../../KEYCLOAK/DOCS/README.md) OAuth2/OIDC conforme [ADR-003](../../../CENTRAL/ARCHITECTURE/ADRs/ADR-003-keycloak-autenticacao.md) com fluxo PKCE para SPAs. Interface de usuário construída com componentes [@carf/ui](../../LIB/TS/UI-COMPONENTS/DOCS/README.md) baseados em shadcn/ui seguindo [ADR-014](../../../CENTRAL/ARCHITECTURE/ADRs/ADR-014-shadcn-ui-component-library.md), incluindo mapas interativos com layers WMS visualizando comunidades e unidades georreferenciadas implementando [UC-010](../../../CENTRAL/REQUIREMENTS/USE-CASES/UC-010-configurar-camadas-wms.md).

Gerenciamento de estado distribuído entre [TanStack Query](../../../CENTRAL/ARCHITECTURE/ADRs/ADR-015-tanstack-query-server-state.md) para server state com cache inteligente e [Zustand](../../../CENTRAL/ARCHITECTURE/ADRs/ADR-019-zustand-client-state.md) para client state local. Build otimizado via [Vite](../../../CENTRAL/ARCHITECTURE/ADRs/ADR-012-vite-bundler-frontend.md) com hot module replacement e deployment contínuo em [Vercel](../../../CENTRAL/ARCHITECTURE/ADRs/ADR-013-vercel-deployment-platform.md) provendo preview deployments automáticos para cada pull request.
