...
- **[ARCHITECTURE/](./ARCHITECTURE/README.md)** - SPA routing integração ADRs decisões técnicas
- **[CONCEPTS/](./CONCEPTS/README.md)** - Autenticação protected routes tenant switcher
- **[FEATURES/](./FEATURES/README.md)** - Gestão unidades holders mapas legitimação relatórios
