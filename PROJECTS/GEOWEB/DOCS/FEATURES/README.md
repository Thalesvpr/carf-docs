...
- **[team-management.md](./03-team-management.md)** - CRUD equipes técnicas assignment members communities roles COORDINATOR ANALYST FIELD_COORDINATOR FIELD_CADASTRATOR notifications email push audit logging
