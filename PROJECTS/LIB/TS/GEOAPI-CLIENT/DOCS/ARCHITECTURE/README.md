...
- **[01-client-architecture.md](./01-client-architecture.md)** - Arquitetura geral cliente HTTP
- **[02-error-handling.md](./02-error-handling.md)** - Estratégia tratamento erros
- **[03-authentication-flow.md](./03-authentication-flow.md)** - Fluxo autenticação tokens
