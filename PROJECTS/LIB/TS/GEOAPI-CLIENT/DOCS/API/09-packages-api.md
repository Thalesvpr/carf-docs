...
O pacote contem tres tipos de dados: versao otimizada de ortofoto em formato PNG para as comunidades autorizadas do usuario (subdiretorios por communityId), poligonos GeoJSON de unidades e comunidades para visualizacao no mapa offline, e metadados pre-cadastrados de comunidades e unidades existentes em formato JSON para pre-popular o WatermelonDB local.
