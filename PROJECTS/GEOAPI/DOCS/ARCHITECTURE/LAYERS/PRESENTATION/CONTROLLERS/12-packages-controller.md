...
O PackagesController gerencia pacotes de dados para download pelo app mobile REURBCAD. A rota base e /api/packages. Os pacotes contem versao otimizada de ortofoto, poligonos GeoJSON e metadados pre-cadastrados necessarios para operacao em campo offline.
