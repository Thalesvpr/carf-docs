...
Descrição: Falta seção GENERATED com índice automático; Muitas listas com bullets (10) antes do rodapé - considerar converter para parágrafo denso.
...
| ID | Titulo |
|:---|:-------|
| [01-units-controller](./01-units-controller.md) | Units Controller |
