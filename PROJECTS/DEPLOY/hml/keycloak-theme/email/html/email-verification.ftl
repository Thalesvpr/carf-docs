...
<table style="width: 100%; max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif;">
    ...
    <tr>
        <td style="padding: 30px 20px; background: #FFFFFF;">
            <h2 style="color: #2C5F2D; margin-top: 0;">${msg("emailVerificationSubject")}</h2>
            <p style="color: #333333; line-height: 1.6;">
                ${msg("emailVerificationBodyHtml",link, realmName, linkExpirationFormatter(linkExpiration))?no_esc}
            </p>
