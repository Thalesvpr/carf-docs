...
Desenvolvimento de novos temas utiliza **Keycloakify** como padrao CARF, permitindo criar temas com React e TypeScript reutilizando componentes @carf/ui. O resultado do build Keycloakify e um JAR instalado da mesma forma que temas tradicionais, sem alteracoes na configuracao do realm. Documentacao em [CONCEPTS/01-keycloak-themes.md](../../CONCEPTS/01-keycloak-themes.md) e [HOW-TO/01-develop-themes.md](../../HOW-TO/01-develop-themes.md).

Referencias: [06-login-theme-carf](../../FEATURES/06-login-theme-carf.md) documentacao do tema CARF, [01-develop-themes](../../HOW-TO/01-develop-themes.md) guia desenvolvimento Keycloakify, [05-theme-customization](../../FEATURES/05-theme-customization.md) visao geral customizacao, Keycloak Theme Configuration keycloak.org/docs/latest/server_admin/#_themes.
