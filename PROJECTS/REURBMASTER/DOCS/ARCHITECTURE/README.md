...
# Arquitetura REURBMASTER - React SPA
...
carf-reurbmaster (SPA)  →  GEOAPI /api/admin/*  →  Keycloak Admin API
...
- carf-reurbmaster README: ADMIN/SRC-CODE/carf-reurbmaster/README.md
