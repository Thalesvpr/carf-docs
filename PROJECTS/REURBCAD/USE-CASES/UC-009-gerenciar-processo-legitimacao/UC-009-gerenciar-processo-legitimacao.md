...
> **Contexto no Workflow:** Este UC e uma FASE SEPARADA, executada APOS a conclusao do workflow principal (PARTE 1-2-3). A legitimacao fundiaria ocorre quando os cadastros ja foram sincronizados e aprovados. Ver [WORKFLOW-MESTRE](../../../../CENTRAL/WORKFLOW-MESTRE/README.md).
