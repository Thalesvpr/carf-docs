...
- **[kustomization.yaml](CENTRAL/DEPLOYMENTS/KUBERNETES/OVERLAYS/PROD/kustomization.yaml)** - Kustomize config referencia base patches prod namespace images tags
- **[replica-patch.yaml](CENTRAL/DEPLOYMENTS/KUBERNETES/OVERLAYS/PROD/replica-patch.yaml)** - Replicas três high availability tolerância falhas
- **[resource-patch.yaml](CENTRAL/DEPLOYMENTS/KUBERNETES/OVERLAYS/PROD/resource-patch.yaml)** - Requests 500m CPU 512Mi memory limits 1000m 1Gi
...
| ID | Titulo |
|:---|:-------|
| [01-kustomization](CENTRAL/DEPLOYMENTS/KUBERNETES/OVERLAYS/PROD/01-kustomization.md) | PROD Overlay |
...
- ○ [[CENTRAL/DEPLOYMENTS/KUBERNETES/OVERLAYS/PROD/01-kustomization.md|PROD Overlay]]
