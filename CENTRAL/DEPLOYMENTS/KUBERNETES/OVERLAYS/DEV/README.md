...
- **[kustomization.yaml](CENTRAL/DEPLOYMENTS/KUBERNETES/OVERLAYS/DEV/kustomization.yaml)** - Kustomize config referencia base patches dev namePrefix namespace
- **[replica-patch.yaml](CENTRAL/DEPLOYMENTS/KUBERNETES/OVERLAYS/DEV/replica-patch.yaml)** - Replicas uma economia recursos cluster local
- **[resource-patch.yaml](CENTRAL/DEPLOYMENTS/KUBERNETES/OVERLAYS/DEV/resource-patch.yaml)** - Requests mínimos 50m CPU 64Mi memory startup rápido
...
| ID | Titulo |
|:---|:-------|
| [01-kustomization](CENTRAL/DEPLOYMENTS/KUBERNETES/OVERLAYS/DEV/01-kustomization.md) | DEV Overlay |
...
- ○ [[CENTRAL/DEPLOYMENTS/KUBERNETES/OVERLAYS/DEV/01-kustomization.md|DEV Overlay]]
