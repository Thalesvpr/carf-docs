...
- **reurb-s-requirements.md** - Requisitos REURB-S (interesse social): área ≤250m², renda ≤3 SM, isenção total custos, procedimentos simplificados
- **reurb-e-requirements.md** - Requisitos REURB-E (interesse específico): área 250-500m², sem limite renda, custos progressivos, documentação técnica robusta
- **ownership-criteria.md** - Critérios de titularidade: titular primário + máximo 3 co-titulares, percentuais de propriedade somam 100%, posse qualificada 5 anos
- **documentation-requirements.md** - Requisitos documentais por modalidade: docs pessoais, comprovantes ocupação, docs técnicos, certidões obrigatórias
- **lei-13465-2017.md** - Base legal: Lei Federal 13.465/2017, prazos 120 dias, legitimação fundiária, direitos beneficiários, vedações
...
- Backend .NET: `PROJECTS/GEOAPI/LAYERS/APPLICATION/VALIDATORS/LegitimationRequestValidator.cs`
- Frontend React: `PROJECTS/GEOWEB/SERVICES/legitimation-service.ts`
- Mobile React Native: `PROJECTS/REURBCAD/SERVICES/legitimation-validator.ts`
