...
Backend REST API central do ecossistema CARF construido em .NET 9 que serve como unico ponto de entrada para todos os clientes. Recebe ortofotos do Analista de Drone, processa e reduz tamanho, armazenando em bucket S3/MinIO segregado por tenant. Expoe endpoints para gestao de unidades habitacionais, titulares, comunidades, processos de legitimacao e documentos. Processa dados geoespaciais usando PostGIS e implementa regras de negocio do dominio REURB.
