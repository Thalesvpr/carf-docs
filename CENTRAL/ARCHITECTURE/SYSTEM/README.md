...
O [ADMIN](./04-admin.md) e o console administrativo para gestao de tenants, usuarios e configuracoes do sistema. O [GEOGIS](./05-geogis.md) e um plugin QGIS para analises espaciais avancadas e geoprocessamento batch. O [WEBDOCS](./06-webdocs.md) e o portal de documentacao tecnica construido com Astro/Starlight. O [KEYCLOAK](./07-keycloak.md) e o identity provider que centraliza autenticacao OAuth2/OIDC para todos os sistemas.
