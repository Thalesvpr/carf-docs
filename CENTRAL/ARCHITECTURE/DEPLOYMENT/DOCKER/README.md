...
- **[DOCKERFILES/](./DOCKERFILES/README.md)** - Dockerfiles multi-stage otimizados por projeto (GEOAPI, GEOWEB, KEYCLOAK, REURBCAD, GEOGIS)
- **[COMPOSE/](./COMPOSE/README.md)** - Docker Compose files por ambiente (dev, staging, prod) orquestrando todos os serviços
