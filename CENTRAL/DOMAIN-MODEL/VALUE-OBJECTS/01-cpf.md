...
- Backend .NET: `PROJECTS/GEOAPI/LAYERS/DOMAIN/VALUE-OBJECTS/01-cpf.md` (class Cpf com validação)
- Frontend React: `PROJECTS/GEOWEB/UTILS/value-objects/cpf.ts` (função validate)
- Mobile React Native: `PROJECTS/REURBCAD/UTILS/cpf.ts` (validação local)
- Plugin GIS Python: `PROJECTS/GEOGIS/UTILS/cpf.py` (validação Python)
