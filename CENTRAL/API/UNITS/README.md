...
Endpoint de Unidades implementado pelo backend [GEOAPI](../../../PROJECTS/GEOAPI/DOCS/ARCHITECTURE/01-overview.md) usando aggregate [UnitAggregate](../../DOMAIN-MODEL/AGGREGATES/01-unit-aggregate.md) conforme [ADR-008: Clean Architecture + DDD](../../ARCHITECTURE/ADRs/ADR-008-clean-architecture-ddd.md), persistido em PostgreSQL+PostGIS via [ADR-002: PostGIS](../../ARCHITECTURE/ADRs/ADR-002-postgresql-postgis.md) com multi-tenancy isolado por [ADR-005: RLS](../../ARCHITECTURE/ADRs/ADR-005-multi-tenancy-rls.md), consumido por [GEOWEB](../../../PROJECTS/GEOWEB/DOCS/README.md) para CRUD web com validações client-side via [@carf/tscore](../../../PROJECTS/LIB/TS/TSCORE/DOCS/CONCEPTS/01-value-objects.md) e [REURBCAD](../../../PROJECTS/REURBCAD/DOCS/README.md) para coleta em campo offline sincronizando via [@carf/geoapi-client](../../../PROJECTS/LIB/TS/GEOAPI-CLIENT/DOCS/README.md), ambos renderizando UI com componentes de [@carf/ui UnitCard](../../../PROJECTS/LIB/TS/UI-COMPONENTS/DOCS/README.md).
