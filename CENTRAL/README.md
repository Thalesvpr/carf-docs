...
O [ecossistema](./ECOSYSTEM/README.md) registra todas as aplicações do CARF com seus metadados de autenticação e branding. O [design system](./DESIGN-SYSTEM/README.md) define a paleta de cores, tipografia e espaçamento para consistência visual.
...
|  | [Design System](./DESIGN-SYSTEM/README.md) | 4 |
|  | [Domain Model](./DOMAIN-MODEL/README.md) | 87 |
|  | [Ecosystem](./ECOSYSTEM/README.md) | 2 |
...
- [[CENTRAL/DESIGN-SYSTEM/README|DESIGN-SYSTEM]]
- [[CENTRAL/DOMAIN-MODEL/README|DOMAIN-MODEL]]
- [[CENTRAL/ECOSYSTEM/README|ECOSYSTEM]]
- [[CENTRAL/INTEGRATION/README|INTEGRATION]]
- [[CENTRAL/LIBRARIES/README|LIBRARIES]]
- [[CENTRAL/OPERATIONS/README|OPERATIONS]]
- [[CENTRAL/REQUIREMENTS/README|REQUIREMENTS]]
- [[CENTRAL/SECURITY/README|SECURITY]]
- [[CENTRAL/STANDARDS/README|STANDARDS]]
- [[CENTRAL/TESTING/README|TESTING]]
- [[CENTRAL/VERSIONING/README|VERSIONING]]
- [[CENTRAL/WORKFLOWS/README|WORKFLOWS]]
